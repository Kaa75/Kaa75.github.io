...
/**
 * SplitText — GSAP-powered character/word/line reveal with ScrollTrigger.
 * Implementation adapted from ReactBits (reactbits.dev/text-animations/split-text).
 * License: MIT — original by David Haz (github.com/DavidHDev/react-bits)
 *
 * Dependencies already installed: gsap, @gsap/react.
 */
  ...
  useGSAP(
    () => {
      ...
      const assignTargets = (self: InstanceType<typeof GSAPSplitText>) => {
        ...
        if (!targets) targets = (self.chars || self.words || self.lines) as Element[] | undefined;
      };
